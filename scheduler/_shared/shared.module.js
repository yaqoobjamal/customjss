import { WidgetHelper, AjaxHelper, DomHelper, IdHelper, Tooltip, Toast, BrowserHelper, StringHelper, LocaleManager, Localizable, DataGenerator, Fullscreen, Events, GlobalEvents, VersionHelper, EventHelper, Popup, ResizeHelper, Rectangle, Widget } from '../../build/scheduler.module.js?439960';
...
const
    ...
    isModule         = pathName.endsWith('module.html') || (moduleTag && moduleTag.src.includes('app.module.js?439960')) || (pathName.endsWith('index.html') && isOnline),
...
class Shared extends Localizable(Events()) {
    ...
    constructor() {
        ...
        if (themeInfo && themes[themeInfo.name.toLowerCase()]) {
            const theme = me.qs('theme', BrowserHelper.getLocalStorageItem('b-example-theme') || defaultTheme);
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?439960' : isUmd ? 'app.umd.js?439960' : 'app.js?439960',
                    items    : [
                        isModule ? 'app.module.js?439960' : isUmd ? 'app.umd.js?439960' : 'app.js?439960'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?439960' : isUmd ? 'app.umd.js?439960' : 'app.js?439960') {
        const me = this;
        ...
        if (filename.endsWith('.js?439960')) {
            me.mode = 'js';
            code    = me.processJS(code);
        }
        else if (filename.endsWith('.css?439960')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href     = `data:text/${this.filename.endsWith('.css?439960') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?439960"]')) {
            filesStore.add({ text : 'resources/app.css?439960', value : 'resources/app.css?439960' });
        }
